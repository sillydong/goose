...
var flagPath = flag.String("path", "migrations", "folder containing migration files")
var flagTable = flag.String("table", "goose_db_version", "table name for goose_db_version")
...
func dbConfFromFlags() (dbconf *goose.DBConf, err error) {
	return goose.NewDBConf(*flagPath, *flagTable, *flagPgSchema)
}
