...
`github.com/sillydong/goose` is a fork of `bitbucket.org/liamstask/goose` with the following changes:
- No config files
...
# Install
    ...
    $ go get -u github.com/sillydong/goose/cmd/goose
...
2. Import `github.com/sillydong/goose`
...
# Hybrid Versioning
Please, read the [versioning problem](https://github.com/sillydong/goose/issues/63#issuecomment-428681694) first.
...
[GoDoc]: https://godoc.org/github.com/sillydong/goose
[GoDoc Widget]: https://godoc.org/github.com/sillydong/goose?status.svg
[Travis]: https://travis-ci.org/sillydong/goose
[Travis Widget]: https://travis-ci.org/sillydong/goose.svg?branch=master
